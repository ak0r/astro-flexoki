...
##### Callout component is not yet available
...
### Image with internal path

<CustomImage
  src="cover.jpg"
  basePath="articles/mdx-elements"
  alt="Being with nature"
  width={300}
  height={200}
  class="shadow-md"
/>
...
### Image with external path
<CustomImage
    src="https://picsum.photos/900/600?random=1.webp"
    alt="Being with nature"
    width={300}
    height={200}
    size="wide"
...
<Gallery galleryName="External Images" variant="masonry">
  <CustomImage
    src="https://picsum.photos/900/600?random=1.webp"
    alt="Being with nature"
    width={900}
  ...
  />
  <CustomImage
    src="https://picsum.photos/900/1200?random=2.webp"
    alt="Being with nature"
    width={900}
    height={900}
  />
  <CustomImage
    src="https://picsum.photos/900/900?random=3.webp"
    alt="Being with nature"
    width={300}
    height={200}
  />
  <CustomImage
    src="https://picsum.photos/900/600?random=4.webp"
    alt="Being with nature"
    width={300}
    height={400}
  />
...
<Gallery galleryName="Gallery" galleryPath="mdx-elements/gallery" variant="masonry" />
